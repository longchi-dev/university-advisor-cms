...
@section('content')
    <div class="card">
        <div class="card-body">
            <a href="{{ route('gemini-keys.create') }}" class="btn btn-primary mb-3">
                ...
                <table class="table table-striped">
                    ...
                    @foreach($keys as $key)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('gemini-keys.edit', $key) }}" class="btn btn-sm btn-warning">
                                    <i class="mdi mdi-pencil"></i>
                                </a>
{{--                                <form action="{{ route('gemini-keys.destroy', $key) }}" method="POST" class="d-inline">--}}
{{--                                    @csrf @method('DELETE')--}}
